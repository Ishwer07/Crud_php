                ...
                while($row = mysqli_fetch_assoc($result))
                {
                   ...
                   <tr>
                       ...
                       <td >". $row["name"]. "</td>
                        ...
                        <td >".'<a class="btn btn-danger" href="delete_data.php?id=$row[id]" role="button">Delete</a>'. "</td>
                        <td >".'<a class="btn btn-success" href="update.php?id=$row[id]" role="button">Update</a>'. "</td>
